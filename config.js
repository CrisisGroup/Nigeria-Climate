var config = {
    ...
    subtitle: '',
    byline: '',
    footer: '<ul><li><strong>Lead Contributor</strong>: Ulrich Eberle</li><li><strong>Visualizations</strong>: Paul Franz</li></ul><br /><em>Empirical analysis is based on Eberle et al. (2020) “Heat and Hate: Climate Security and Farmer-Herder Conflicts in Africa”</em><br /><br /><strong>Data Sources</strong>: ACLED, CCI-LC (ESA), CRU, GADM, WRI, OpenStreetMap, Mapbox<br /><br /><img src="images/crisis_group_dark_logo.png" width="150" height="150" />',
    chapters: [
        {
            id: 'intro',
            alignment: 'left',
